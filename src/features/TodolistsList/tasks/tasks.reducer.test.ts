import {TasksDomainType, tasksReducer, tasksThunks} from "features/TodolistsList/tasks/tasksReducer";
...
test('correct task should be added to correct array', () => {
	...
	const action = tasksThunks.createTask.fulfilled(
		{newTask},
		'requestId',
...
test('new array should be added when new todolist is added', () => {
	...
	const action = todolistsThunks.createTodo.fulfilled({todolist}, 'requestId', todolist.title);
...
test('property with todolistId should be deleted', () => {
	...
	const action = todolistsThunks.deleteTodo.fulfilled({todolistId: id}, 'requestId', id);
